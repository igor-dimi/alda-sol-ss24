...
Das ist nicht moeglich, da Kopieren einer Liste oder eines Arrays der Laenge $n$ $\mathcal{O}(n)$
Operationen benoetigen wuerde. Unsere "in-place" Algorithmen sind bereits $\mathcal{O}(n)$